...
PAGES = [
    ...
    # ---------------- Accounts (net worth) ----------------
    {"title": "My Accounts — Net Worth", "module": "Accounts", "url": "/accounts", "code": "NW",
     "keys": "net worth net worth accounts dashboard money manager balances assets liabilities"},
    {"title": "Import / Sync Cashbook", "module": "Accounts", "url": "/accounts/import", "code": "AI",
     "keys": "import import money manager upload sync csv data accounts file"},
    {"title": "Account Reports", "module": "Accounts", "url": "/accounts/reports", "code": "AR",
     "keys": "net worth reports accounts reports hub statements cashflow income expense trial balance"},
    {"title": "Monthly Cash Flow", "module": "Accounts · Reports", "url": "/accounts/reports/cashflow", "code": "ACF",
     "keys": "cash flow cash flow accounts inflow outflow movement money in out period"},
    ...
    {"title": "Account Statements", "module": "Accounts · Reports", "url": "/accounts/reports/statements", "code": "STM",
     "keys": "statements statements accounts transactions ledger account history period"},
    ...
    {"title": "Order Projection — Cash Planner", "module": "Trade", "url": "/trade/projection", "code": "TJ",
     "keys": "cash projection projection cash forecast sheet daily plan future runway negative"},
    ...
    {"title": "Working Capital & Capital Utilization", "module": "Trade · Reports", "url": "/trade/reports/working-capital", "code": "WC",
     "keys": "working capital working capital dso dpo ccc cash conversion cycle current ratio roce health"},
    ...
    {"title": "Receivables Aging", "module": "Trade · Reports", "url": "/trade/reports/aging", "code": "AG",
     "keys": "ar aging ar aging receivables overdue buckets days customer collect debtors chase"},
    {"title": "Payables Aging", "module": "Trade · Reports", "url": "/trade/reports/ap-aging", "code": "AP",
     "keys": "ap aging ap aging payables overdue buckets days vendor owe creditors"},
